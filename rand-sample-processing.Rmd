...
extr1_colony <- extr1_colony %>% 
  mutate(extraction_id = 'extr-1')

print(extr1_colony[ , c("cryo_id","extraction_id")])

write_csv(extr1_colony, "extr1_21APR23.csv")

```

```{r}
metadata %>%
   filter(between(colony, 1, 4) & cryo_rep == "a")
```
